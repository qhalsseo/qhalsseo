...
<%
	...
	try{
		...
		MultipartRequest multi = new MultipartRequest(request, realFolder, maxSize, encType,	// cos.jar가 없으면 사용 안됨.서드파티이기 때문에 api가 시키는대로 코딩
				new DefaultFileRenamePolicy());	// 같은 파일명 업로드시 파일이름 변경 처리하는 객체 생성자 
%>
